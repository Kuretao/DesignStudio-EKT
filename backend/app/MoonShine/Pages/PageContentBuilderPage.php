    ...
    private function sitePageCatalog(): array
    {
        ...
        return [
            ...
            [
                ...
                'sections' => [
                    ['id' => 'hero', 'title' => 'Первый экран, цифры и направления', 'kind' => 'Hero', 'group' => 'about-full', 'prefixes' => ['aboutFull.hero.', 'aboutFull.stats.', 'aboutFull.directions.'], 'description' => 'Фон, изображение карточки, заголовок, текст, кнопки, статистика и список направлений.'],
                    ...
                    ['id' => 'team', 'title' => 'Команда и направления работы', 'kind' => 'Медиа и список', 'group' => 'about-full', 'prefixes' => ['aboutFull.work.', 'aboutFull.team.'], 'description' => 'Три изображения с подписями, описание команды и список компетенций.'],
